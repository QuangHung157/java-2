                            ...
                            <main>
                                <div class="container-fluid px-4">
                                    ...
                                    <ol class="breadcrumb mb-4">
                                        ...
                                        <li class="breadcrumb-item active"><a href="/admin/product/create">Create</a>
                                        </li>
                                    </ol>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-12 mx-auto">
                                                ...
                                                <form:form method="post" action="/admin/product/create"
                                                    modelAttribute="newProduct" class="row needs-validation"
                                                    ...
                                                    <div class="mb-3 col-12 col-md-6">
                                                        ...
                                                        <div class="invalid-feedback">Please enter a valid price (>= 0).
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-3 col-12 col-md-6">
                                                        ...
                                                        <div class="invalid-feedback">Please choose a target group.
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-3 col-12 col-md-6">
                                                        ...
                                                        <input class="form-control" type="file" id="avatarFile"
                                                            name="File" accept=".png, .jpg, .jpeg" required />
                                                        <div class="invalid-feedback">Please choose an image file
                                                            (png/jpg/jpeg).</div>
                                                    </div>
